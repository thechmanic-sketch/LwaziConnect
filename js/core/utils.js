...
const VC={
 ...
 aiassist:{t:'AI School Assistant',a:'New Query',i:'ti-sparkles'},idcards:{t:'Digital Learner ID Cards',a:'Print Batch',i:'ti-printer'},homework:{t:'Homework & Assignments',a:'Set Homework',i:'ti-plus'},commscentre:{t:'Communication Centre',a:'New Broadcast',i:'ti-broadcast'},hr:{t:'HR & Staff Management',a:'Add Staff Member',i:'ti-user-plus'},transport:{t:'Transport Management',a:'Add Vehicle',i:'ti-plus'},website:{t:'School Website Builder',a:'Publish Changes',i:'ti-world'},sgb:{t:'SGB Governance',a:'Schedule Meeting',i:'ti-calendar-plus'},compliance:{t:'Security & Compliance',a:'Run Backup Now',i:'ti-shield-check'},enterprise:{t:'Enterprise / Multi-Campus',a:'Add Campus',i:'ti-plus'},groups:{t:'Groups & Clubs',a:'Create Group',i:'ti-users-group'},
};
...
function V(v){
 ...
 aiassist:rAI,idcards:rIDCards,homework:rHomework,commscentre:rCommsCentre,hr:rHR,transport:rTransport,website:rWebsite,sgb:rSGB,compliance:rCompliance,enterprise:rEnterprise,groups:rGroups};
 (fn[v]||rDash)(area);
}
...
function topAction(){
 ...
 aiassist:()=>{document.getElementById('aiInput')?.focus();},idcards:()=>T('Batch of '+D.students.length+' ID cards queued for printing','success'),homework:mSetHomework,commscentre:mNewBroadcast,hr:mAddStaff,transport:mAddVehicle,website:()=>T('Website changes published live','success'),sgb:mSchedMeeting,compliance:()=>T('Manual backup started — complete in ~2 minutes','success'),enterprise:mAddCampus,groups:mAddGroup};
 (A[CV]||openQuickAdd)();
}
