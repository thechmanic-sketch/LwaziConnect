...
const ROLE_PROFILES = {
 ...
 teacher:    {name:'P. Mahlangu',ini:'PM',bg:'#DCFCE7',fg:'#16A34A',label:'Teacher',nav:['dashboard','students','classes','subjects','timetable','attendance','reportcards','homework','messages','announcements','documents','calendar']},
